...
- **MCP Specification** - [modelcontextprotocol.io](https://modelcontextprotocol.io/specification/2025-06-18)
- **FastMCP Framework** - Python SDK for building MCP servers ([GitHub](https://github.com/modelcontextprotocol/python-sdk))
