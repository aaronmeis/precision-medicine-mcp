...
See [GCP Testing Guide](../../docs/deployment/GCP_TESTING_GUIDE.md) for details.
...
Part of the Precision Medicine MCP suite (demonstrated in [PatientOne](../../docs/architecture/patient-one/README.md) workflow):
