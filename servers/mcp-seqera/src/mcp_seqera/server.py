...
To enable real data processing, set: SEQERA_DRY_RUN=false
...
def main() -> None:
    ...
    if DRY_RUN:
        ...
        logger.warning("⚠️  Set SEQERA_DRY_RUN=false for production use")
        logger.warning("=" * 80)
    else:
        logger.info("✅ Real data processing mode enabled (SEQERA_DRY_RUN=false)")
